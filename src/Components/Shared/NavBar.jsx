  ...
  return (
    <div className="navbar bg-primary text-white relative z-50">
      <div className="navbar-start">
        ...
        <Link
          to={"/"}
          className="ml-10 btn btn-link text-white no-underline hover:no-underline normal-case text-2xl absolute"
        >
          <img
            src={logo}
            alt="Marvel Logo"
            className="h-10 border-2 border-gray-300 rounded-full w-10"
          />
          Diamond Dreams
        </Link>
      </div>
      ...
      <div className="navbar-end hidden lg:flex lg:justify-center lg:items-center">
        <ul className="font-bold p-2 bg-primary rounded-box lg:flex lg:justify-center lg:items-center gap-4">
          ...
          <li className="border-2 border-white rounded-full flex items-center justify-center h-8 w-8">
            <label className="swap swap-rotate">
              {/* this hidden checkbox controls the state */}
              <input type="checkbox" onChange={handelToggle} />
