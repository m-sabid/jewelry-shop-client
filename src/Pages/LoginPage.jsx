...
const LoginPage = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://img.freepik.com/free-vector/jewelry-shop-display-with-gold-necklaces-rings_107791-11967.jpg')",
    ...
    >
      ...
      <div className="bg-white bg-opacity-70 rounded-lg shadow-md p-10 relative z-10">
